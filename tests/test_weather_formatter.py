...
class TestWeatherFormatter:
    ...
    def test_format_weather_table_success(self):
        ...
        weather_results = {
            "Chisinau": WeatherForecastResult(
                success=True,
                data=WeatherData(
                    city="Chisinau",
                    date="2025-09-03",
        ...
        result = self.formatter.format_weather_table(weather_results)
    ...
    def test_format_weather_table_no_valid_data(self):
        """Test formatting when all requests failed"""
        weather_results = {
            "Chisinau": WeatherForecastResult(success=False, error_message="API Error"),
            "Madrid": WeatherForecastResult(
                success=False, error_message="Network Error"
            ),
            "Kyiv": WeatherForecastResult(success=False, error_message="Timeout"),
            "Amsterdam": WeatherForecastResult(
    ...
    def test_format_weather_table_partial_data(self):
        """Test formatting with some cities having failed requests"""
        weather_results = {
            "Chisinau": WeatherForecastResult(
                success=True,
                data=WeatherData(
            ...
            "Madrid": WeatherForecastResult(success=False, error_message="API Error"),
            "Kyiv": WeatherForecastResult(success=False, error_message="Network Error"),
            "Amsterdam": WeatherForecastResult(
                success=True,
                data=WeatherData(
                    city="Amsterdam",
